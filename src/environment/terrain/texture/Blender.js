...
let getMaterial = () => {
    return new Promise((res, rej) => {
        textureLoader().then(t => {
            t[0].repeat.x = 6; t[0].repeat.z = 6
            t[1].repeat.x = 6; t[1].repeat.z = 6
            t[2].repeat.x = 100; t[2].repeat.z = 100
            t[3].repeat.x = 100; t[3].repeat.z = 100
            t[4].repeat.x = 100; t[4].repeat.z = 100
            t[6].repeat.x = 10; t[6].repeat.z = 10
